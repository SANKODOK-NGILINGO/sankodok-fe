...
const IeltsLogin = () => {
  ...
  return (
    <section className="flex min-h-screen w-full">
      <div className="bg-[#FFD0FF] w-1/3 relative">
        <Image
          src={char}
          alt="char"
          className="fixed w-52 lg:w-60 bottom-0 left-0"
        />
      </div>
        ...
        <div className="flex flex-col gap-12 w-full max-w-3xl">
          <div className="w-full space-y-2">
            ...
            <h1 className="text-center font-bold text-3xl">
              All set! Practice IELTS with AI-driven feedback
            </h1>
          </div>
          <div className="w-full justify-center items-center">
            <div className="space-y-4 px-12">
              ...
              <div className="space-y-6">
                ...
                <Button className="w-full h-12 bg-pink-200 hover:bg-pink-300 rounded-full border border-black text-black">
                  Sign Up
                </Button>
